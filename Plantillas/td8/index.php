...
<body>
	...
	<header class="index-banner">
		...
		<nav class="main-header">
			<div id="brand" data-aos="zoom-in-up">
				...
				<div id="word-mark">
					<h1>
						<a href="index.html">Espacios de Coworking</a>
					</h1>
				</div>
			</div>
			<div id="menu">
				...
				<ul class="text-center text-capitalize nav-agile" data-aos="zoom-in-up">
					...
					<li>
						<a href="#choose" class="scroll">Espacios</a>
					</li>
					<li>
						<a href="#overview" class="scroll">Servicios</a>
					</li>
					...
					<div class="slider-info col-lg-8">
						<div class="agileinfo-logo mt-5">
							<h2 data-aos="fade-down">
								<span class="fab fa-blackberry text-center"></span> Lic Elsa Mastinez P.
							</h2>
						</div>
						<h3 class="txt-w3_agile" data-aos="fade-down">Fundadora y Directora</h3>
						<a class="btn mt-4 mr-2 text-capitalize" data-aos="fade-up" href="#" data-toggle="modal" data-target="#exampleModalCenter1" role="button">Ver Instalaciones</a>
					</div>
		...
		<section class="footer footer_w3layouts_section_1its py-5">
			<div class="container py-md-4">
				...
				<div class="row footer-top mt-md-5 mt-4">
					...
					<div class="col-lg-8 col-md-12 mt-md-0 mt-10 footer-grid_section_1its_w3" data-aos="fade-up">
						<div class="footer-grid_section text-center" data-aos="zoom-in">
							...
							<ul class="social_section_1info">
								...
								<li class="mb-2 twitter"><a href="#"><i class="fa-brands fa-x-twitter"></i>twitter</a></li>
								<li class="mb-2 whatsapp"><a href="#"><i class="fa-brands fa-whatsapp"></i>Whatsapp</a></li>
								<li class="mb-2 instagram"><a href="#"><i class="fa-brands fa-instagram"></i>Instagram</a></li>
							</ul>
						</div>
					</div>
	...
	<div class="cpy-right text-center py-3">
		<p class="">2024, made with <i class="fa fa-heart heart text-danger"></i> by
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<img src="images/banner.jpg" class="img-fluid" alt="Modal Image" />
