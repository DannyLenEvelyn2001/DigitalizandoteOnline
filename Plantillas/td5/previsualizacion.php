...
<head>
    <title id="title">Mi Negocio</title>
...
<body>
    ...
    <script>
        ...
        window.addEventListener('message', function(event) {
            ...
            document.querySelector('.colorEncabezado2').style.color = formData.colorEncabezado;
            ...
            document.querySelector('.colorTiServ').style.color = formData.colorTiServ;
            document.querySelector('.colorTiServ1').style.color = formData.colorTiServ;
            ...
            document.querySelector('.colorDesc1').style.color = formData.colorDesc;
            ...
            document.querySelector('colorCarrusel').style.color = formData.colorCarrusel;
            document.getElementById('tituloCarr').textContent = formData.tituloCarr;
            if (formData.img1) {
                var reader = new FileReader();
                reader.onload = function(e) {
            ...
            document.querySelector('.color31').style.color = formData.color3;
            ...
            document.getElementById('desP1').textContent = formData.desP1;
            document.getElementById('desP2').textContent = formData.desP2;
